...
const WelcomeScreen = ({ onStart }: WelcomeScreenProps) => {
  return (
    <motion.div
      ...
      className="flex flex-col items-center justify-center px-6 text-center max-w-lg mx-auto"
    >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={onStart}
        className="bg-gradient-primary px-10 py-3.5 rounded-full text-primary-foreground font-semibold text-lg tracking-wide shadow-lg shadow-primary/30"
      >
        Start
      </motion.button>
    </motion.div>
